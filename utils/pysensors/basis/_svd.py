...
class SVD(TruncatedSVD, InvertibleBasis, MatrixMixin):
    ...
    Assumes the Data_total has already been centered (to have mean 0).
    ...
    basis_matrix_ : numpy ndarray, shape (n_features, n_basis_modes)
        The top n_basis_modes left singular vectors of the training Data_total.
