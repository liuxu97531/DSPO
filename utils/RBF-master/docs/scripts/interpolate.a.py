''' 
In this example we generate synthetic scattered Data_total with added noise
...
# fitting the noisy Data_total exactly. By setting `phi` to "phs2", the interpolant
