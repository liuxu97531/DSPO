...
def rejection_sampling(size, rho, domain, start=0, 
    ...
    # form a Halton sequences to generate the random number between 0 and 2
    ...
    while points.shape[0] < size:
        ...
        # distribution between 0 and 2. Here I form the test points and those
        # random numbers
...
def poisson_discs(rfunc, domain, seeds=10, ntests=50, 
    ...
    specified value. This algorithm is based on [2], and it has been modified
    ...
    References
    ----------
    [2] Bridson, R., Fast Poisson Disk Sampling in Arbitrary Dimensions.
