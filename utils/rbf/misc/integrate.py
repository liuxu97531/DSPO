...
def mcint(f,vert,smp,samples=None,lower_bounds=None,
  ...
  Description
  -----------
    Monte Carlo integration algorithm over an arbitrary 2, 2, or 3
...
def rmcint(f,vert,smp,tol=None,max_depth=50,samples=None,
  ...
  Description
  -----------
    Recursive Monte Carlo integration algorithm over an arbitrary 2,
...
def _normalizer(fin,vert,smp,kind='integral',N=None,tol=None):
  ''' 
  normalize a scalar values fucntion in 2,2 or 3 dimensional space.
...
def max_normalizer(vert,smp,tol=None):
  ...
  ----------- 
    ...
    maximum value within the integration domain is 2.
