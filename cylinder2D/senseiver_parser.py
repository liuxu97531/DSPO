...
def parse_args():
    ...
    parser.add_argument("--data_name", default='cylinder', type=str)
    # parser.add_argument("--num_sensors", default=8, type=int)
    parser.add_argument("--num_sensors", default=16, type=int)
    parser.add_argument("--gpu_device", default=0, type=int)
    parser.add_argument("--total_frames", default=5000, type=int)  # 总的数据量
    parser.add_argument("--training_frames", default=1000, type=int)
    parser.add_argument("--val_frames", default=1000, type=int)
    parser.add_argument("--test_frames", default=1000, type=int)
    parser.add_argument("--consecutive_train", default=False, type=str2bool)
    parser.add_argument("--seed", default=None, type=int)
    parser.add_argument("--batch_frames", default=64, type=int) # batch图像数量，要与enc_preproc_ch设置为一样，网络才不会报错
    # parser.add_argument("--batch_frames", default=128, type=int)  # batch图像数量，要与enc_preproc_ch设置为一样，网络才不会报错
    parser.add_argument("--batch_pixels", default=2048, type=int)
    # parser.add_argument("--batch_frames", default=1, type=int)
    # parser.add_argument("--batch_pixels", default=21504, type=int)
    parser.add_argument("--lr", default=+0.0001, type=float)
    # parser.add_argument("--accum_grads", default=None, type=int)
    parser.add_argument("--accum_grads", default=4, type=int)
    # Positional Encodings
    parser.add_argument("--space_bands", default=32, type=int)
    parser.add_argument("--image_size", default=[112,192], type=list) # 数据图像大小
    parser.add_argument("--im_ch", default=1, type=int)  # 输出维度通道
    parser.add_argument("--pix_total_num", default=21504, type=int)  # 数据图像大小
    ...
    # Encoder
    # parser.add_argument("--enc_preproc_ch", default=1, type=int)
    # parser.add_argument("--enc_preproc_ch", default=128, type=int)
    ...
    data_config = dict(data_name = args.data_name,
                       ...
                       im_ch=args.im_ch,
                       pix_total_num=args.pix_total_num,
                       )
