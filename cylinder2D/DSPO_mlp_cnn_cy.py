...
class Solver_rec(Solver_basic):
    def __init__(self,):
        ...
        self.net = CNNRecon(sensor_num=args.num_obs, fc_size=(7, 12)).to(self.device)
    ...
    def train(self, xobs_optimizer):
        ...
        # args.epochs, iter_obs_update = 3, 10
    ...
    def Predict(self, loading=True):
        ...
        test_loss = self.std*test_loss / len(test_loader.dataset)
...
if __name__ == '__main__':
    ...
    for num_obs in [4, 8, 16]:
        ...
        np.save('./logs/RandomSampler1/{}_best_test_loss_num_{}.npy'.format(args.model, args.num_obs), best_test_loss)
